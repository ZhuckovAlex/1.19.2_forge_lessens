package net.sanberdir.lessen_192_forge.entity.chest_boat;
...
import net.sanberdir.lessen_192_forge.entity.boat.ModBoatTypes;
import net.sanberdir.lessen_192_forge.entity.boat.ModEntityData;
import net.sanberdir.lessen_192_forge.items.ModEntitiesItem;
...
public class ModChestBoatEntity extends ChestBoat {
    ...
    protected void defineSynchedData()
    {
        ...
        this.entityData.define(MOD_CHEST_BOAT_TYPE, ModBoatTypes.CUSTOM.ordinal());
    }
    ...
    public Item getDropItem() {
        switch(this.getModChestBoatType()) {
            case CUSTOM:
            default:
                return ModEntitiesItem.CUSTOM_CHEST_BOAT;
        }
    }
}
